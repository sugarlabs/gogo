...
#========================================
    ...
    def download(self):
        ...
        self.txCompiledCode(self.byteCode, self.byteCodeCount)
...
class GoGoComms:
    ...
    def compile(self, text, ErrMsgFunc=None):
        return self.cricketIF.compile(text, ErrMsgFunc)
    ...
    def autoUpload(self, progress_cb=None):
        return self.gogoIF.autoUpload(progress_cb)
